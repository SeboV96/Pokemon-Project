...
const evolution = async (evol) => {
    try {
        ...
        let result = {
            ...
            img: apiPokeUrl.data.sprites.versions["generation-v"]["black-white"].animated.front_default || apiPokeUrl.data.sprites.front_default,
        }
        if(evoDetails){
...
const getApiInfo = async () => {
    ...
    for(let i = 0 ; i < results.length ; i++){
        ...
        pokemonInfo.push({
            ...
            img: pokeInfo.sprites.versions["generation-v"]["black-white"].animated.front_default || pokeInfo.sprites.front_default,
...
const getPokeInfo = async (id) => {
    try {
        ...
        img: results.sprites.versions["generation-v"]["black-white"].animated.front_default || results.sprites.front_default,
