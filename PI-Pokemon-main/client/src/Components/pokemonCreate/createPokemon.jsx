...
function Validate(currentInput){
    ...
    return (
        ...
        <div className='form'>
            ...
            <h1>Create your PokeFriend!</h1>
            <from >
                <div>
                    <spam>Name : </spam>
                    <input name = 'name' type = 'text' placeholder = 'Your own PokeName!' value = {currentInput.name} onChange = {(ev) => hanlderNameControl(ev)} required/>
                    {
                ...
                <spam>Height : </spam>
                    ...
                    <input name='height' value = {currentInput.height} type = 'number' placeholder = '1 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                ...
                <spam>Health Points (HP) : </spam>
                    <input name='hp' value = {currentInput.hp} type = 'number' placeholder = '20 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                ...
                <spam>Attack Power : </spam>
                    <input name='attack' value = {currentInput.attack} type = 'number' placeholder = '1 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                ...
                <div>
                <spam>Defense : </spam>
                    <input name='defense' value = {currentInput.defense} type = 'number' placeholder = '1 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                ...
                <div>
                <spam>Speed : </spam>
                    <input name = 'speed' value = {currentInput.speed} type = 'number' placeholder = '1 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                ...
                <div>
                <spam>Weight : </spam>
                    <input name='weight' value = {currentInput.weight} type = 'number' placeholder = '1 to 100' onChange = {(ev) => handlerNumbers(ev)}/>
                    {
                        currentErrors.weight && (<p className='alertWeight'>{currentErrors.weight}</p>)
                    }
                </div>
                <div>
                <spam>Image : </spam>
                    <input name='img' value = {currentInput.img} type = 'URL' placeholder = 'URL...' onChange = {(ev) => handlerImg(ev)}/>

                </div>
            <button className='submit' onClick={handlerSubmit} type = "submit">Create PokeFriend!</button>
            </from>
        </div>
